...
router
    ...
    .get("/usuarios/:id", AuthMiddleware, GrupoMiddleware("visualizar_usuarios"), UsuarioController.listarUsuarioID)
    .patch("/usuarios/:id", AuthMiddleware, GrupoMiddleware("alterar_usuarios"), usuarioValidation.alterarUsuarioValidate, UsuarioController.alterarUsuario)
    .delete("/usuarios/:id", AuthMiddleware, GrupoMiddleware("deletar_usuarios"), UsuarioController.deletarUsuario);

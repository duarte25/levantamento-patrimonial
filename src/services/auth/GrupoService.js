...
export default class GrupoService {
    ...
    */
    ...
    static possuiPermissaoRecurso(req, nomeRecurso, campusRecurso, usuarioRecurso, qualPermissao, qualAcao = false) {
        ...
        if (campusRecurso) {
            if (!GrupoService.possuiPermissaoQualquerCampus(req, campusRecurso, qualPermissao, qualAcao)) {
                return `Você não tem permissão para manipular um ${nomeRecurso} que não é de seu campus`;
            }
        }
